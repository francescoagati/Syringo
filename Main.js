...
Test.prototype.testContainerValues = function() {
	this.assertEquals(this.container.get("title"),"titolo",{ fileName : "Test.hx", lineNumber : 49, className : "Test", methodName : "testContainerValues"});
	this.assertEquals(this.container.get("list").length,3,{ fileName : "Test.hx", lineNumber : 50, className : "Test", methodName : "testContainerValues"});
	this.assertEquals(this.container.get("person").name,"Mario",{ fileName : "Test.hx", lineNumber : 51, className : "Test", methodName : "testContainerValues"});
}
Test.prototype.testAnnotationValues = function() {
	var object = new TestClass(this.container);
	this.assertEquals(object.title,"titolo",{ fileName : "Test.hx", lineNumber : 56, className : "Test", methodName : "testAnnotationValues"});
	this.assertEquals(object.user.name,"Mario",{ fileName : "Test.hx", lineNumber : 57, className : "Test", methodName : "testAnnotationValues"});
	this.assertEquals(object.collection.length,3,{ fileName : "Test.hx", lineNumber : 58, className : "Test", methodName : "testAnnotationValues"});
}
...
syringo.Injector.injectByAnnotation = function(object,container) {
	...
	var flds = haxe.rtti.Meta.getFields(cls);
	Lambda.foreach(Reflect.fields(flds),function(prop) {
		var obj = Reflect.field(flds,prop);
		if(Reflect.hasField(obj,"inject")) {
...
TestClass.__meta__ = { fields : { title : { inject : ["title"]}, collection : { inject : ["list"]}, user : { inject : ["person"]}}};
js.Lib.onerror = null;
Main.main()