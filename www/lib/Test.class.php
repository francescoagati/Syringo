...
class Test extends haxe_unit_TestCase {
	...
	public function testCheckCacheCallOnlyOne() {
		...
		$this->assertEquals(_hx_len($this->container->get("list")), 3, _hx_anonymous(array("fileName" => "Test.hx", "lineNumber" => 87, "className" => "Test", "methodName" => "testCheckCacheCallOnlyOne")));
		$this->container->get("list")->push("ciao");
		$this->assertEquals(_hx_len($this->container->get("list")), 4, _hx_anonymous(array("fileName" => "Test.hx", "lineNumber" => 89, "className" => "Test", "methodName" => "testCheckCacheCallOnlyOne")));
	}
	public function testWithoutCache() {
		$list = $this->container->getWithoutCache("list");
		$this->assertEquals(_hx_len($this->container->getWithoutCache("list")), 3, _hx_anonymous(array("fileName" => "Test.hx", "lineNumber" => 95, "className" => "Test", "methodName" => "testWithoutCache")));
		$this->container->getWithoutCache("list")->push("ciao");
		$this->assertEquals(_hx_len($this->container->getWithoutCache("list")), 3, _hx_anonymous(array("fileName" => "Test.hx", "lineNumber" => 97, "className" => "Test", "methodName" => "testWithoutCache")));
	}
	public function testAnnotationValues() {
		$object = new TestClass($this->container);
		$this->assertEquals($object->title, "titolo", _hx_anonymous(array("fileName" => "Test.hx", "lineNumber" => 103, "className" => "Test", "methodName" => "testAnnotationValues")));
		$this->assertEquals($object->user->name, "Mario", _hx_anonymous(array("fileName" => "Test.hx", "lineNumber" => 104, "className" => "Test", "methodName" => "testAnnotationValues")));
		$this->assertEquals($object->collection->length, 3, _hx_anonymous(array("fileName" => "Test.hx", "lineNumber" => 105, "className" => "Test", "methodName" => "testAnnotationValues")));
		$this->assertEquals($object->sum(1, 1), 2, _hx_anonymous(array("fileName" => "Test.hx", "lineNumber" => 107, "className" => "Test", "methodName" => "testAnnotationValues")));
		$this->assertEquals($object->sum10(100), 110, _hx_anonymous(array("fileName" => "Test.hx", "lineNumber" => 108, "className" => "Test", "methodName" => "testAnnotationValues")));
	}
